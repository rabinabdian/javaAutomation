...
public class seleniumEx4 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
Exercise 4:
⦁	Build a tool which will get your ISP information
⦁	Open https://whatismyipaddress.com/  
⦁	Extract the IP address from the UI
⦁	Go to ⦁	http://ripe.net 
⦁	Type in the extracted IP address and perform search on the RIPE Database(Whois).
⦁	Print the whole block of the second result.
